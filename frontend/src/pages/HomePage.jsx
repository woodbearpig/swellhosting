  ...
  return (
    <div data-testid="home-page">
      ...
      <section className="container-narrow py-14 sm:py-18 lg:py-24">
        <motion.div {...fadeInUp}>
          <SectionHeader eyebrow="WHAT WE DO" title="Designed for the moments that matter" subtitle="We style celebrations end-to-end — from balloons to florals, backdrops to signage." />
        </motion.div>
      ...
      <section className="container-narrow py-14 sm:py-18 lg:py-24">
        <motion.div {...fadeInUp} className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
          <SectionHeader eyebrow="RECENT WORK" title="Moments we've styled" subtitle="A glimpse into the celebrations we've been lucky to design." />
      ...
      <section className="container-narrow py-14 sm:py-18 lg:py-24">
        <motion.div {...fadeInUp}>
          <SectionHeader eyebrow="THE PROCESS" title="A calm, collaborative process" subtitle="No overwhelm, no cookie-cutter kits — just thoughtful design from first inquiry to install." />
        </motion.div>
        <ol className="mt-10 grid grid-cols-1 md:grid-cols-5 gap-4" data-testid="home-process-timeline">
          {[
            { t: 'Inquiry', d: 'Tell us about your event via our smart form.' },
            { t: 'Design call', d: 'A relaxed conversation to align on the vision.' },
            { t: 'Proposal', d: 'A tailored proposal with pricing + palette.' },
            { t: 'Install', d: 'We handle the build, delivery, and on-site setup.' },
            { t: 'Enjoy', d: 'You show up and take it all in. That\u2019s it.' },
          ].map((step, idx) => (
            <li key={step.t} className="card-cream p-5">
              ...
              <p className="font-serif text-lg">{step.t}</p>
              <p className="text-sm text-[color:var(--brand-text-muted)] mt-1.5">{step.d}</p>
            </li>
          ))}
        </ol>
      </section>
      ...
      {/* TESTIMONIALS */}
      <section className="container-narrow py-14 sm:py-18 lg:py-24">
        <motion.div {...fadeInUp}><SectionHeader eyebrow="KIND WORDS" title="Loved by families & brands" /></motion.div>
      ...
      {/* FAQ PREVIEW */}
      <section className="container-narrow py-14 sm:py-18 lg:py-24">
        <motion.div {...fadeInUp}><SectionHeader eyebrow="COMMON QUESTIONS" title="Good things to know" /></motion.div>
