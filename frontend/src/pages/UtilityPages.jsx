...
export const NotFoundPage = () => (
  <div className="container-narrow py-24 text-center" data-testid="notfound-page">
    ...
    <div className="mt-6 flex items-center justify-center gap-3"><Link to="/" className="btn-primary">Back home</Link><Link to="/portfolio" className="btn-secondary">Browse the portfolio</Link></div>
  </div>
);
